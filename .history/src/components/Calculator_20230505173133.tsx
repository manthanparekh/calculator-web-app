...
const Calculator: React.FC<{}> = () => {
    ...
    const handelAllClear = () => setInputs([]);

    const handelUndo = () => setInputs((prev) => prev.slice(0, -1));
    ...
    return (
        <Container>
            <Grid>
                ...
                <Button label="AC" position={[0, 1]} onClick={handelAllClear} />
                <Button label="Undo" position={[1, 1]} width={2} onClick={handelUndo} />
